...
The final commentary is generated using a fine tuned language model. We employ a Gemma based model adapted through supervised fine tuning with efficient parameter adaptation techniques.
